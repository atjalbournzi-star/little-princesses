...
var MASTER_SCHEMA_MAP = {
  ...
  "purchases": {
    ...
    fields: [
      ...
      { key: "supplier_phone", header: "رقم المورد" },
      ...
      { key: "discount", header: "الخصم / التخفيض" },
...
function resetAndSeedCleanChartOfAccounts(optionalSheet) {
  ...
  return { success: true, message: "تم تنظيف وتصفير شجرة الحسابات وإعادة زراعة الحسابات القياسية الـ 25 بنجاح 👑", count: masterAccounts.length };
}
