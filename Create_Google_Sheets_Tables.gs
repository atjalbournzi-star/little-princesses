...
function setupERPDatabaseWithData() {
  ...
  var tablesData = {
    ...
    'Accounts': {
      ...
      rows: [
        [1111, 'الصندوق الرئيسي', 'أصول متداولة', 0],
        [1112, 'البنك / الشبكة وPOS', 'أصول متداولة', 0],
        [1121, 'عهد الورشة والمشغل', 'أصول متداولة', 0],
        [1131, 'ذمم العميلات', 'أصول متداولة', 0],
        [1141, 'سلف الخياطين والعاملين', 'أصول متداولة', 0],
        [1151, 'مخزون الأقمشة والخامات', 'أصول متداولة', 0],
        [1152, 'إنتاج تحت التشغيل (WIP)', 'أصول متداولة', 0],
        [1153, 'مخزون الفساتين التامة', 'أصول متداولة', 0],
        [2111, 'ذمم الموردين ومحلات الأقمشة', 'التزامات متداولة', 0],
        [2121, 'دفعات مقدمة وعرابين حجز', 'التزامات متداولة', 0],
        [2131, 'مستحقات وأجور الخياطين', 'التزامات متداولة', 0],
        [3111, 'رأس المال المباشر Little Princesses', 'حقوق ملكية', 0],
        [3112, 'الأرباح المبقاة / المحتجزة', 'حقوق ملكية', 0],
        [4111, 'إيرادات تفصيل وتصميم الفساتين', 'إيرادات النشاط', 0],
        [4121, 'إيرادات مبيعات فساتين المعرض', 'إيرادات النشاط', 0],
        [4211, 'أرباح تسويات المخزون', 'إيرادات أخرى', 0],
        [5111, 'تكلفة الأقمشة والمواد المباعة', 'تكلفة المبيعات', 0],
        [5121, 'أجور خياطة وتصنيع مباشرة', 'تكلفة المبيعات', 0],
        [5211, 'مصاريف تشغيل وصيانة الورشة', 'مصاريف تشغيلية', 0],
        [5221, 'خسائر وفروقات عجز الجرد', 'مصاريف تشغيلية', 0]
      ]
    },
