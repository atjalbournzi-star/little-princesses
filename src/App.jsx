    ...
    <div className="min-h-screen bg-[#FAFAFB] text-[#25232A] flex flex-row w-full overflow-x-hidden font-sans" dir="rtl">
      ...
      <div className="flex-1 flex flex-col min-w-0 h-screen overflow-y-auto">
        ...
        <main className="flex-1 px-4 md:px-6 lg:px-8 py-6 max-w-[1600px] w-full mx-auto pb-20">
          ...
          {activeTab === "vouchers"   && typeof Vouchers !== 'undefined'   && <Vouchers vouchers={vouchers} setVouchers={setVouchers} accounts={accounts} setAccounts={setAccounts} journal={journal} setJournal={setJournal} showToast={showToast} currency={systemCurrency} customers={customers} setCustomers={setCustomers} orders={orders} setOrders={setOrders} expenses={expenses} setExpenses={setExpenses} />}
          ...
          {activeTab === "reports"    && typeof Reports !== 'undefined'    && <Reports orders={orders} expenses={expenses} vouchers={vouchers} journal={journal} accounts={accounts} purchases={purchases} customers={customers} inventory={inventory} showToast={showToast} currency={systemCurrency} />}
